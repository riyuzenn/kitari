...
function Banner({ title, videourl, synopsis, rating, airingtime, released, onWatchClick, onAddClick }: BannerProps) {
    return (
        <>
            ...
            "
                >
                    ...
                    <div className="flex space-x-5">
                        <button
                            ...
                            className="py-2 px-2 text-[12px] w-36 xl:w-40 flex justify-center items-center
                ...
                text-[#252525] hover:text-[#353535]"
                        ...
                        <button
                            onClick={onAddClick}
                            className="py-2 px-2 w-40 flex justify-center items-center
